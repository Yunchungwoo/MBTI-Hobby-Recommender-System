          ...
          <div className="FindtoID-selected">
            <div className="FindtoID-container">
              ...
              <img
                ...
                style={{
                  cursor: selectedButton === "ID" ? "default" : "pointer",
                }}
              />
              ...
              <img
                ...
                style={{
                  cursor: selectedButton === "PASS" ? "default" : "pointer",
                }}
              />
...
export default FindtoPasswordhome;
