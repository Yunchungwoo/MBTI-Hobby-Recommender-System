...
const NewPass = () => {
  ...
  const [showEyeNewPassword, setShowEyeNewPassword] = useState(false);
  const [showEyeVerifyPassword, setShowEyeVerifyPassword] = useState(false);
                    ...
                    <div className="NewPassword-input-container-input-textbox">
                      <div className="NewPassword-input-container-input-text">
                        <input
                          ...
                          onFocus={() => setShowEyeNewPassword(true)}
                          onBlur={() => setShowEyeNewPassword(false)}
                        />
                      </div>
                      <img
                        className="eye"
