...
import line2 from "../img/line-8-3.svg";
          ...
          <div className="ID-info-containerbox">
            <div className="ID-info-box">
              ...
              <div className="ID-details-1">
                ...
                <div className="info-value-1">123123123</div>
                <div className="info-value-2">20xx.xx.xx</div>
              ...
              <div className="ID-details-2">
                ...
                <div className="info-value-4">123123123</div>
                <div className="info-value-5">20xx.xx.xx</div>
