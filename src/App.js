...
import TestPage5 from './components/Test/TestPage5.js';
import TestPage6 from './components/Test/TestPage6.js';
import ResultPage from './components/Result/Result.js';
import ResultAiPage from './components/Result/ResultAiPage.js';
    ...
    <Router>
      <div>
        <Routes>
          ...
          <Route path="/Test/step5" element={<TestPage5 updateAnswers={updateAnswers} allAnswers={allAnswers} />}/>
          <Route path="/Test/step6" element={<TestPage6 updateAnswers={updateAnswers} allAnswers={allAnswers} />}/>
          <Route path="/Test/result" element={<ResultPage allAnswers={allAnswers} />} />
          <Route path="/Test/resultai" element={<ResultAiPage allAnswers={allAnswers} />} />
        </Routes>
      </div>
    </Router>
  );
