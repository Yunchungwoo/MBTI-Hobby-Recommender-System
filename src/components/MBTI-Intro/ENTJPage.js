          ...
          <div className="main-content">
            <div className="content-wrapper">
              ...
              <div className="image-content">
                <img src={bannerimage} alt="ENTJ personality banner" />
              </div>
            </div>
...
export const ENTJTitle1 = "목표 달성을 위한 노력"
export const ENTJTitle2 = "감정 표현의 필요성"
export const ENTJIntro1 = "ENTJ는 타고난 리더로, 카리스마와 자신감을 바탕으로 사람들을 목표 달성을 위해 이끕니다. 냉철한 이성과 열정, 결단력, 지적 능력을 활용해 자신이 원하는 것을 성취하며, 비즈니스와 단체에서 강한 존재감으로 리더 역할을 자주 맡습니다."
export const ENTJSubText1 = "타고난 리더들은 강한 카리스마와 자신감을 바탕으로 사람들을 이끄는 능력을 갖추고 있습니다. 이들은 단순히 권력을 행사하는 것에 그치지 않고, 사람들을 공통된 목표로 이끌어 함께 노력하게 만듭니다. 이러한 성향은 그들의 냉철한 이성과 결합되어, 문제 해결이나 목표 달성을 위해 열정과 결단력, 그리고 뛰어난 지적 능력을 활용합니다. 이들은 종종 비즈니스나 단체를 이끄는 중요한 역할을 맡게 되는데, 그 이유는 그들의 존재감이 매우 강렬하며 다른 성격 유형보다 더 많은 영향력을 발휘하기 때문입니다. 이 때문에 그들이 있는 곳에서는 대부분의 사람들을 압도하는 리더십을 보입니다. 이러한 특성 덕분에 이들은 조직 내에서 중요한 결정을 내리고, 그룹이 나아가야 할 방향을 설정하는 데 탁월한 역할을 합니다."
export const ENTJIntro2 = "ENTJ는 도전을 즐기며 충분한 자원과 시간이 주어지면 어떤 목표도 달성할 수 있다고 믿습니다. 전략적 사고와 결단력으로 비즈니스 리더로서 성공할 가능성이 높고, 강한 의지로 어려운 상황에서도 목표를 포기하지 않습니다."
export const ENTJSubText2 = "ENTJ는 도전적인 상황에서 큰 성과를 내는 성격 유형으로, 충분한 시간과 자원이 주어진다면 어떤 목표든 달성할 수 있다고 믿습니다. 그들의 강력한 의지와 전략적 사고 능력은 복잡한 문제 해결에 탁월하며, 이를 통해 비즈니스에서 성공적인 리더가 될 가능성이 높습니다. 특히 장기적 목표를 설정하고 이를 달성하기 위해 결단력 있게 계획을 실행하는 능력은 비즈니스 리더로서의 자질을 돋보이게 만듭니다. 이들은 외향적 성향(E)을 바탕으로 다른 사람들과의 협력을 이끌어내는 데 능숙하며, 포기하지 않는 성격 덕분에 어려운 상황에서도 끝까지 목표를 추구합니다. 또한, 협상이나 논쟁에서 우위를 점하고, 상대방을 논리적으로 압도하는 데 자신이 있습니다. 그러나 이들이 냉정하거나 악한 의도를 가진 것은 아니며, 단순히 지적 대결과 도전을 즐기기 때문에 재치 있게 논쟁을 이끄는 것을 좋아할 뿐입니다. ENTJ는 효율성을 중시하며, 목표 달성 과정에서 감정에 큰 비중을 두지 않습니다. 그들은 일을 명확하고 정확하게 처리하는 사람을 존경하며, 자신의 팀에서 능력 있는 인재를 파악하는 능력을 가지고 있습니다. 이런 능력은 그들이 조직을 성공적으로 이끌고 팀의 성과를 극대화하는 데 중요한 역할을 합니다. 다만, 다른 사람의 실패를 노골적으로 지적하는 성향으로 인해 갈등이 발생할 수 있어, 이 부분에서 주의가 필요합니다. 결론적으로, ENTJ는 강한 리더십과 결단력으로 목표를 이루고자 하는 성향을 지닌 사람으로, 비즈니스나 조직에서 중요한 역할을 수행할 가능성이 큽니다."
export const ENTJIntro3 = "ENTJ는 감정을 드러내는 것을 약점으로 여겨 무관심한 인상을 주지만, 이는 친밀한 관계 형성에 방해가 됩니다."
export const ENTJSubText3 = "모든 분석가형 성격, 특히 ENTJ는 자신의 감정을 표현하는 데 익숙하지 않습니다. 이들은 종종 감정을 드러내는 것을 약점으로 생각하며, 이는 특히 직장 내에서 두드러집니다. 이들은 효율성에 매우 중점을 두기 때문에, 비효율적이거나 무능력한 사람에 대해 거침없이 비판적인 태도를 보일 수 있습니다. 이는 감정적으로 무관심한 사람이라는 인상을 줄 수 있으며, 다른 사람과의 관계 형성에 어려움을 초래할 수 있습니다. 하지만 이들이 자신의 감정적 표현을 억누르는 것은 장기적으로 친밀한 관계를 형성하는 데 방해가 될 수 있습니다. 직장에서 목표를 달성하는 것만큼 팀원의 기여와 피드백을 인정하는 것도 중요하다는 사실을 깨닫는 것이 필요합니다. 이러한 인정을 통해 팀원들이 더 나은 성과를 내고, 그들 자신도 리더로서의 위치를 더욱 강화할 수 있습니다. ENTJ는 대개 에너지와 자신감이 넘치며, 다른 사람에게도 큰 영감을 주는 인물로 비춰집니다. 그러나 자신의 성공이 주변 사람들의 도움 덕분이라는 사실을 잊지 말아야 하며, 다른 사람의 감정과 욕구에 주의를 기울이는 것이 중요합니다. 처음에는 다른 사람의 감정을 고려하는 것이 불편하게 느껴질 수 있지만, 공감 능력을 키우기 위한 노력이 중요합니다. 공감이 강화되면, 이들은 강력한 리더십을 유지하면서도 의미 있는 인간관계를 구축하고 더 큰 성공을 달성할 수 있습니다. 궁극적으로, 감정적 인식을 높이면 더욱 균형 잡힌 리더가 되어 팀과 함께 더 큰 목표를 달성할 수 있을 것입니다."
export const ENTJrecommendhobby = "ENTJ 성향을 가진 사람들에게 어울리는 취미는 그들의 주도적이고 전략적인 성격에 맞춘 활동들입니다. 그들은 도전과 목표 달성에 흥미를 느끼고 리더십을 발휘하는 것을 좋아하므로, 그에 맞는 취미를 추천드릴게요. ENTJ들은 문제 해결과 경쟁을 즐기기 때문에 체스와 같은 전략 게임에 큰 흥미를 느낄 수 있습니다. 그들은 논리적 사고와 계획 수립을 통해 이기는 게임을 좋아할 가능성이 높습니다. 또한, ENTJ는 리더십이 강하기 때문에 그룹 활동에서 리더 역할을 할 수 있는 팀 스포츠도 어울립니다. 축구, 농구와 같은 단체 스포츠뿐만 아니라, 클라이밍이나 마라톤과 같은 개인 도전적인 스포츠도 좋습니다. 새로운 목표를 설정하고 달성하는 것을 좋아하는 ENTJ들은 자격증 취득을 위한 공부나 새로운 기술을 배우는 취미에도 관심이 있을 수 있습니다. 예를 들어, 새로운 언어를 배우거나 프로그래밍에 도전하는 것도 ENTJ의 성향에 잘 맞는 활동입니다. 마지막으로, ENTJ는 생산적이고 효율적인 활동을 선호하기 때문에 프로젝트나 비즈니스 관련 취미, 예를 들어 창업 관련 모임에 참여하거나 새로운 비즈니스 아이디어를 구상하는 것도 매우 흥미롭게 느낄 것입니다."