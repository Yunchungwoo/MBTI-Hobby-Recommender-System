          ...
          <div className="main-content">
            <div className="content-wrapper">
              ...
              <div className="image-content">
                <img src={bannerimage} alt="ESTJ personality banner" />
              </div>
            </div>
...
export const ESTJTitle1 = "모범을 보이는 지도자"
export const ESTJTitle2 = "높은 책임감"
export const ESTJIntro1 = "ESTJ는 전통과 질서를 중시하며, 정직과 헌신을 바탕으로 가족과 공동체의 화합을 위해 노력합니다. 이들은 명확한 조언과 지도로 사람들을 이끌고, 전통적인 가치관을 지키며 화합을 이끄는 일에서 자부심을 느낍니다."
export const ESTJSubText1 = "ESTJ 성격 유형을 가진 사람들은 전통과 질서를 매우 중요하게 여기는 성향을 가지고 있습니다. 이들은 옳고 그름에 대한 확고한 기준을 가지고 있으며, 가족과 공동체가 조화를 이루도록 노력합니다. ESTJ는 정직함, 헌신, 그리고 존엄성을 우선시하며, 어려운 상황에서도 자신이 옳다고 믿는 길을 앞장서서 개척하고자 합니다. 이들은 명확하고 실질적인 조언을 제공하는 능력이 뛰어나며, 다른 사람들을 이끌고 올바른 방향으로 나아갈 수 있도록 돕는 역할을 맡습니다. 또한, 공동체가 한데 모여 화합할 수 있도록 행사나 활동을 주도하는 데 자부심을 느끼고, 전통적인 가치관을 지키기 위해 노력하는 모습을 자주 보입니다. 예를 들어, 지역 축제를 준비하거나 가족 간의 전통을 이어가는 일을 통해 공동체의 발전에 기여하는 것입니다. 이를 통해 ESTJ는 사람들 사이의 협력과 조화를 이끌어내며, 공동체에 질서와 안정감을 제공하는 중요한 역할을 합니다."
export const ESTJIntro2 = "ESTJ는 법치와 권위를 중시하며, 정직과 성실함으로 모범을 보이는 지도자입니다. 이들은 명확한 사실과 원칙에 따라 행동하며, 직접 헌신하고 어려운 작업을 처리하는 능력을 지닙니다."
export const ESTJSubText2 = "ESTJ는 매우 중요한 지도력을 가진 성격으로, 이들은 법과 질서를 중시하며, 권위를 얻기 위해서는 올바른 노력이 필요하다고 믿습니다. 경영자는 자신의 헌신과 정직함을 바탕으로 모범을 보이는 지도자입니다. 이들은 나태함이나 부정행위와 같은 비윤리적인 행동을 절대 용납하지 않습니다. 경영자는 사실을 중요하게 생각하고, 자신의 지식과 경험에 대해 강한 신념을 가지고 있습니다. 그들은 원칙을 고수하고, 저항이 있더라도 자신의 비전을 실현하려고 노력합니다. 어려운 프로젝트에서도 주도적으로 행동하고, 계획을 구체화하며 문제를 해결하는 데 탁월한 능력을 보입니다. 또한, 이들은 혼자 일하기보다는 팀워크를 중시하며, 다른 사람들에게도 높은 수준의 업무 윤리와 성실함을 기대합니다. 부정직하거나 무능력한 사람들에 대해 엄격하게 대처하는 경향이 있으며, 이러한 성향으로 인해 때때로 융통성이 없다는 평가를 받기도 합니다. 그러나 ESTJ는 자신이 고집이 센 것이 아니라, 성실함과 정직함이 사회의 필수적인 가치라고 믿는 것입니다."
export const ESTJIntro3 = "ESTJ는 모범 시민으로서 이웃을 돕고 법을 준수하며, 집단에 기여하도록 노력합니다."
export const ESTJSubText3 = "ESTJ는 전형적인 모범 시민으로, 이웃을 돕고 법을 준수하며 집단과 조직에 기여하려고 항상 노력하는 성격입니다. 이들은 사회적 질서와 법을 중요시하며, 자신뿐만 아니라 주변 사람들도 사회에 긍정적인 영향을 미칠 수 있도록 도우려는 강한 책임감을 느낍니다. 하지만 경영자는 모든 사람이 자신과 같은 방식으로 기여하거나 같은 길을 가야 한다고 생각하는 경향이 있어, 이를 이해하는 데 어려움을 겪을 수 있습니다. 그들이 자신의 강점인 리더십을 발휘하면서도 개별적 차이를 인정한다면, 더 나은 결과를 가져오고 더 많은 사람에게 영향을 미칠 수 있을 것입니다."
export const ESTJrecommendhobby = "ENFJ 성격 유형에 어울리는 취미는 그들의 사회적 성향, 이타심, 창의성을 살릴 수 있는 활동이 적합합니다. ENFJ는 사람들과의 상호작용에서 큰 만족감을 느끼고, 다른 사람을 돕고 이끌며 성취감을 느끼는 성격이므로, 취미에서도 이러한 요소를 반영하는 것이 좋습니다."