...
function RegisterPage2() {
  ...
  const handleNextClick = async () => {
    ...
    try {
      const response = await axios.post('https://localhost:8000/api/register/', userData);
              ...
              <div className="signup-textboxgroup2">
                <div className="signup-textbox-1">
                  ...
                  <input
                    ...
                    placeholder="이메일(필수)"
                    value={email}
                    onChange={(e) => setEmail(e.target.value)} // 이메일 입력 관리
                  />
                </div>
              </div>
            </div>
              ...
              <div className="signup-textboxgroup2">
                <div className="signup-textbox-1">
                  ...
                  <input
                    ...
                    placeholder="닉네임"
                    value={nickname}
                    onChange={(e) => setNickname(e.target.value)} // 닉네임 입력 관리
                  />
                </div>
              </div>
            </div>
            ...
            <div className="signup-textboxgroup-5">
              <div className="signup-textbox-1">
                ...
                <input
                  ...
                  placeholder="이름"
                  value={fullName}
                  onChange={(e) => setFullName(e.target.value)} // 이름 입력 관리
                />
              </div>
            </div>
            <div className="signup-textboxgroup-6">
              <div className="signup-textbox-1">
                ...
                <input
                  ...
                  value={birthDate}
                  onChange={(e) => setBirthDate(e.target.value)} // 생년월일 입력 관리
                />
              </div>
            </div>
