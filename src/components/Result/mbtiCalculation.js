export const calculateMbtiScores = (answers) => {
    ...
    const questionMapping = {
      "E/I": [1, 6, 11, 16, 21, 26, 31, 36, 40, 44, 48, 52, 56],
      "S/N": [2, 7, 12, 17, 22, 27, 32, 37, 41, 45, 49, 53, 57],
      "T/F": [3, 8, 13, 18, 23, 28, 33, 38, 42, 46, 50, 54, 58],
      "J/P": [4, 9, 14, 19, 24, 29, 34, 39, 43, 47, 51, 55, 59]
    };
